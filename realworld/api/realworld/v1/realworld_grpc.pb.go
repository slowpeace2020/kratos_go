...
type RealWorldClient interface {
	...
	Register(ctx context.Context, in *RegistrationRequest, opts ...grpc.CallOption) (*UserReply, error)
	...
	GetComments(ctx context.Context, in *GetCommentsRequest, opts ...grpc.CallOption) (*MultipleComments, error)
...
func (c *realWorldClient) Register(ctx context.Context, in *RegistrationRequest, opts ...grpc.CallOption) (*UserReply, error) {
	out := new(UserReply)
...
func (c *realWorldClient) GetComments(ctx context.Context, in *GetCommentsRequest, opts ...grpc.CallOption) (*MultipleComments, error) {
...
type RealWorldServer interface {
	...
	Register(context.Context, *RegistrationRequest) (*UserReply, error)
	...
	GetComments(context.Context, *GetCommentsRequest) (*MultipleComments, error)
...
func (UnimplementedRealWorldServer) Register(context.Context, *RegistrationRequest) (*UserReply, error) {
...
func (UnimplementedRealWorldServer) GetComments(context.Context, *GetCommentsRequest) (*MultipleComments, error) {
...
func _RealWorld_Register_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(RealWorldServer).Register(ctx, req.(*RegistrationRequest))
	}
	return interceptor(ctx, in, info, handler)
}
