...
func RegisterRealWorldHTTPServer(s *http.Server, srv RealWorldHTTPServer) {
	...
	r.PUT("/api/articles", _RealWorld_UpdateArticle0_HTTP_Handler(srv))
	...
	r.GET("/api/articles/{slug}/comments", _RealWorld_DeleteComment0_HTTP_Handler(srv))
...
type RealWorldHTTPClient interface {
	...
	GetComments(ctx context.Context, req *GetCommentsRequest, opts ...http.CallOption) (rsp *MultipleComments, err error)
	...
	Register(ctx context.Context, req *RegistrationRequest, opts ...http.CallOption) (rsp *UserReply, err error)
...
func (c *RealWorldHTTPClientImpl) GetComments(ctx context.Context, in *GetCommentsRequest, opts ...http.CallOption) (*MultipleComments, error) {
...
func (c *RealWorldHTTPClientImpl) Register(ctx context.Context, in *RegistrationRequest, opts ...http.CallOption) (*UserReply, error) {
	var out UserReply
	pattern := "/api/users"
	path := binding.EncodeURL(pattern, in, false)
